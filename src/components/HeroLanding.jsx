    ...
    return (
        <>
            <motion.img
                ...
                className='absolute md:top-32 top-48 -left-40' src="/images/pattern-rings.svg" />
            <section className='page-wrapper flex md:flex-row flex-col-reverse items-center justify-between md:pb-0 pb-7'>
                <div className='md:text-left text-center md:mt-[134px] mt-[40px] relative z-10'>
                    ...
                    <p className='md:max-w-[380px] w-[380px] md:text-[18px] text-[16px] md:mx-0 mx-auto py-[50px]'>Based in the UK, I'm a front-end developer passionate about building accessible web apps that users love.</p>
                    <a href='https://github.com/Keys78' target={'_blank'}><CustomButton text={'Contact Me'} /></a>
                </div>
